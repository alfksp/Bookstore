...
public class BookControllerConstants {
    ...
    public static final String BOOK_NOT_FOUND = "Book wasn't found";
    public static final String BOOK_ADDED = "Book was added";
    public static final String BOOK_NOT_ADDED = "Book wasn't added";
